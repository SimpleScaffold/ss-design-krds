...
- KRDS 공식 컴포넌트 `checkbox` 패턴이 필요할 때
- `data-krds-component="checkbox"` / `data-krds-reference="assets/krds/html/code/checkbox.html"`로 출처 추적
...
<div data-krds-component="checkbox" data-krds-reference="assets/krds/html/code/checkbox.html">
  <!-- assets/krds/html/code/checkbox.html 구조 참조 -->
</div>
```
