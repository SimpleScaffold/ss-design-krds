...
- KRDS 공식 컴포넌트 `accordion` 패턴이 필요할 때
- `data-krds-component="accordion"` / `data-krds-reference="assets/krds/html/code/accordion.html"`로 출처 추적
...
<div class="krds-accordion">
	...
	<div class="accordion-item">
		...
		<div id="accordionCollapseSample02" class="accordion-collapse collapse" aria-labelledby="
<!-- truncated -->
```
...
<div data-krds-component="accordion" data-krds-reference="assets/krds/html/code/accordion.html">
  <!-- assets/krds/html/code/accordion.html 구조 참조 -->
</div>
```
