...
<div class="form-group font-krds w-full max-w-3xl" data-krds-component="date_input">
	<div class="form-tit">
		<label for="cal">레이블</label>
	</div>
	<div class="form-conts">
		<div class="form-conts calendar-conts">
			<div class="calendar-input">
				<input type="number" class="krds-input datepicker cal w-full font-krds text-krds-text border border-krds-border rounded-krds-sm px-krds-4 py-krds-3 bg-krds-surface" placeholder="YYYY.MM.DD" id="cal" />
