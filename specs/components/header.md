...
- KRDS 공식 컴포넌트 `header` 패턴이 필요할 때
- `data-krds-component="header"` / `data-krds-reference="assets/krds/html/code/header.html"`로 출처 추적
...
<div data-krds-component="header" data-krds-reference="assets/krds/html/code/header.html">
  <!-- assets/krds/html/code/header.html 구조 참조 -->
</div>
```
