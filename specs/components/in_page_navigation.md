...
<div class="krds-in-page-navigation-area font-krds sticky top-krds-4" data-krds-component="in_page_navigation">
		<div class="in-page-navigation-header">
			<p class="quick-caption">이 페이지의 구성</p>
			<p class="quick-title">장애아동수당</p>
		</div>
		...
		<div class="in-page-navigation-action">
			<button type="button" class="krds-btn medium inline-flex items-center justify-center font-krds text-krds-text rounded-krds-sm font-bold transition-colors min-h-[42px] px-krds-4 py-krds-3 border text-krds-body-md">온라인 신청하기</button>
			<p class="quick-info">장애아동수당 외 <strong>1건</strong></p>
		</div>
	</div>
```
