...
- KRDS 공식 컴포넌트 `help_panel` 패턴이 필요할 때
- `data-krds-component="help_panel"` / `data-krds-reference="assets/krds/html/code/help_panel.html"`로 출처 추적
...
<div data-krds-component="help_panel" data-krds-reference="assets/krds/html/code/help_panel.html">
  <!-- assets/krds/html/code/help_panel.html 구조 참조 -->
</div>
```
