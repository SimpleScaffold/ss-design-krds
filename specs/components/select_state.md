...
- KRDS 공식 컴포넌트 `select_state` 패턴이 필요할 때
- `data-krds-component="select_state"` / `data-krds-reference="assets/krds/html/code/select_state.html"`로 출처 추적
...
<div data-krds-component="select_state" data-krds-reference="assets/krds/html/code/select_state.html">
  <!-- assets/krds/html/code/select_state.html 구조 참조 -->
</div>
```
