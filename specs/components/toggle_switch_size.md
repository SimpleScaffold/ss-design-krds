...
- KRDS 공식 컴포넌트 `toggle_switch_size` 패턴이 필요할 때
- `data-krds-component="toggle_switch_size"` / `data-krds-reference="assets/krds/html/code/toggle_switch_size.html"`로 출처 추적
...
<div data-krds-component="toggle_switch_size" data-krds-reference="assets/krds/html/code/toggle_switch_size.html">
  <!-- assets/krds/html/code/toggle_switch_size.html 구조 참조 -->
</div>
```
